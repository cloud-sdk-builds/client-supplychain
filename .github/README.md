...
[`@aws-sdk/client-supplychain`](https://www.npmjs.com/package/@aws-sdk/client-supplychain/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-supplychain@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HNNl5N0xb2DBWIsPcAtv50D+cb0b0QKEdmUWlNN/ik6JyzOXXXD5Zj4agb3mAJz3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-supplychain": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-supplychain@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-supplychain@3.501.0/index.min.mjs": "sha384-HNNl5N0xb2DBWIsPcAtv50D+cb0b0QKEdmUWlNN/ik6JyzOXXXD5Zj4agb3mAJz3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-supplychain/blob/refs/tags/3.501.0/LICENSE
```
